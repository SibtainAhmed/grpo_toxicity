...
accelerate launch --main_process_port=29525 \
    ...
    --output_dir=output_tox_grpo_tracin_2.7b_fp16_kl-0.04_ep-2_rcap-4.1_samebatch_gen-8_mbs-32_seed-22 \
    --init_kl_coef=0.04 \
    --steps=1000 \
    --min_length=20 \
    --temperature=1.0 \
    --wandb_project="grpo-detox" \
    --run_name="grpo-tracin-2.7b-fp16-kl-0.04-ep-2_rcap-4.1_samebatch_gen-8_mbs-32_seed-22" \
    --tracin \
    --with_validation \
    ...
    --gen_data_dir="gen_tox_grpo_samples_tracin_2.7b_fp16_kl-0.04_ep-2_rcap-4.1_samebatch_gen-8_mbs-32_seed-22"
