...
accelerate launch --main_process_port=29525 \
    ...
    --output_dir=output_tox_grpo_tracin_2.7b_bfloat16_kl-0.04_val-1024_tgt-seqloss-lastadv_mbs-1_seed-22 \
    --init_kl_coef=0.04 \
    --steps=200 \
    --min_length=20 \
    --temperature=1.0 \
    --wandb_project="grpo-detox" \
    --run_name="grpo-tracin-2.7b-bfloat16-kl-0.04-val-1024_tgt-seqloss-lastadv_mbs-1_seed-22" \
    --tracin \
    --with_validation \
    --val_loss_type="seqloss-lastadv" \
    --gen_data_dir="gen_tox_grpo_samples_tracin_2.7b_bfloat16_kl-0.04_val-1024_tgt-seqloss-lastadv_mbs-1_seed-22"
